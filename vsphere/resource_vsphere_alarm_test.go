		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testAccResourceAlarmCheckExists(true),
					resource.TestCheckResourceAttr("vsphere_alarm."+AlarmResource, "email_action.0.to", "test@broadcom.com"),
					resource.TestCheckResourceAttr("vsphere_alarm."+AlarmResource, "email_action.0.cc", "test@ovh.com"),
