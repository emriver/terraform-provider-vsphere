		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.vsphere_alarm.alarm", "email_action.0.to", "test@broadcom.com"),
					resource.TestCheckResourceAttr("data.vsphere_alarm.alarm", "email_action.0.cc", "test@vmware.com"),
